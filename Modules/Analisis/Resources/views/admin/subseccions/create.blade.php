...
@section('content-header')
    <h1>
        {{ trans('analisis::subseccions.title.create subseccion') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.analisis.subseccion.index') }}">{{ trans('analisis::subseccions.title.subseccions') }}</a></li>
        <li class="active">{{ trans('analisis::subseccions.title.create subseccion') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.analisis.subseccion.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('analisis::admin.subseccions.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
