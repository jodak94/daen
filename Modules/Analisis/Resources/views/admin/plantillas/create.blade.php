...
@section('content-header')
    <h1>
        {{ trans('analisis::plantillas.title.create plantilla') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.analisis.plantilla.index') }}">{{ trans('analisis::plantillas.title.plantillas') }}</a></li>
        <li class="active">{{ trans('analisis::plantillas.title.create plantilla') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.analisis.plantilla.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('analisis::admin.plantillas.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
