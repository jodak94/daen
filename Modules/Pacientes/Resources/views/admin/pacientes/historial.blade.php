                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('pacientes::admin.pacientes.partials.historial-fields', ['lang' => $locale])
                        </div>
                    @endforeach

                    <div class="box-footer">
                        <a class="btn btn-default pull-right btn-flat" href="{{ route('admin.pacientes.paciente.index')}}">Volver</a>
                    </div>
                </div>
