...
@section('content-header')
    <h1>
        {{ trans('empresas::empresas.title.edit empresa') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.empresas.empresa.index') }}">{{ trans('empresas::empresas.title.empresas') }}</a></li>
        <li class="active">{{ trans('empresas::empresas.title.edit empresa') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.empresas.empresa.update', $empresa->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('empresas::admin.empresas.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
